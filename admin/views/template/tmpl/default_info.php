...
<div class="row-fluid">
	<div class="span6">
		<h2><?php echo JText::_("COM_JCCDEV_TEMPLATE_INFO") ?></h2>
		<table class="table">
			<tbody>
				<tr>
					<td><?php echo JText::_("COM_JCCDEV_TEMPLATE_FIELD_VERSION_LABEL") ?>:</td>
					<td><?php echo $this->item->version; ?></td>
				</tr>
				<tr>
					<td><?php echo JText::_("COM_JCCDEV_TEMPLATE_FIELD_INSTALLED_LABEL") ?>:</td>
					<td>
				...
				<tr>
					<td><?php echo JText::_("COM_JCCDEV_TEMPLATE_FIELD_LANGUAGES_LABEL") ?>:</td>
					<td>
				...
				<tr>
					<td><?php echo JText::_("COM_JCCDEV_TEMPLATE_FIELD_AUTHOR_LABEL") ?>:</td>
					<td>
						<i class="icon-user"></i>
	...
	<div class="span1">&nbsp;</div>
	<div class="span5">
		<h2><?php echo JText::_("COM_JCCDEV_TEMPLATE_DOWNLOAD") ?></h2>
		<table class="table">
			<tbody>
				<tr>
