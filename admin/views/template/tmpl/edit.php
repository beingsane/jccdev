...
<form action="<?php JRoute::_('index.php?option=com_jccdev&id=' . (int)$this->item->id); ?>" method="post" name="adminForm" id="template-form" class="form-validate form-horizontal">
...
<div id="j-main-container" class="span12">
	...
	<div class="row-fluid">
		<div class="span4">
			<h4><?php echo JText::_('COM_JCCDEV_TEMPLATE_FIELDSET_REQUIRED'); ?></h4>
		...
		<div class="span4">
			<h4><?php echo JText::_('COM_JCCDEV_TEMPLATE_FIELDSET_PARAMS'); ?></h4>
