...
<?php foreach ($this->items as $i => $item) : ?>
    <tr class="row<?php echo $i % 2; ?>">
        ...
        <td>
            <a href="<?php echo JRoute::_('index.php?option=com_jccdev&task=field.edit&id=' . $item->id); ?>"><?php echo $this->escape($item->name); ?></a>
        </td>
        <td>
            <?php
        ...
        <td>
            <?php if (!empty($item->jccdev_formfield_id)) : ?>
                <a href="<?php echo JRoute::_("index.php?option=com_jccdev&task=formfield.edit&id=" . $this->escape($item->jccdev_formfield_id)) ?>">
        ...
        <td>
            <?php if (!empty($item->jccdev_formrule_id)) : ?>
                <a href="<?php echo JRoute::_("index.php?option=com_jccdev&task=formrule.edit&id=" . $this->escape($item->jccdev_formrule_id)) ?>">
