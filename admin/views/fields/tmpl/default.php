...
<form action="<?php echo JRoute::_('index.php?option=com_jccdev&view=fields'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped" id="fieldList">
		...
		<thead>
			<tr>
				...
				<th class="nowrap left">
					<a><?php echo JText::_('COM_JCCDEV_FIELD_FIELD_TABLE_LABEL') ?></a>
				</th>
				<th class="nowrap left">
