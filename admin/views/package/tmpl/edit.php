...
<form action="<?php JRoute::_('index.php?option=com_jccdev'); ?>" method="post" name="adminForm" id="package-form" class="form-validate form-horizontal">
...
<?php endif;?>
	...
	<?php echo JHtml::_('bootstrap.startTabSet', 'package', array('active' => 'general')); ?>
		<?php echo JHtml::_('bootstrap.addTab', 'package', 'general', JText::_('COM_JCCDEV_PACKAGE_VIEW'), true); ?>
	<div class="row-fluid">
		<div class="span4">
			<h4><?php echo JText::_('COM_JCCDEV_PACKAGE_FIELDSET_LABEL'); ?></h4>
