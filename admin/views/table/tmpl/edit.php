...
<h2><?php echo !empty($this->item->name) ? "#__" . $this->item->dbname : JText::_("COM_JCCDEV_TABLE_NEW"); ?></h2>
<form action="<?php JRoute::_('index.php?option=com_jccdev&id=' . (int)$this->item->id); ?>" method="post" name="adminForm" id="table-form" class="form-validate form-horizontal">
<div class="row-fluid">

<div id="j-main-container" class="span12">
	<?php echo JHtml::_('bootstrap.startTabSet', 'table', array('active' => 'general')); ?>
		<?php echo JHtml::_('bootstrap.addTab', 'table', 'general', JText::_('COM_JCCDEV_VIEW_TABLE'), true); ?>
	<div class="row-fluid">
		<div class="span4">
			<h4><?php echo JText::_('COM_JCCDEV_TABLE_FIELDSET_REQUIRED'); ?></h4>
			...
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('JCC', 'params'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('JCC', 'params'); ?></div>
			</div>
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('Twig', 'params'); ?></div>
				<div class="controls"><?php echo $this->form->getInput('twig', 'params'); ?></div>
			</div>
			<div class="control-group">
		...
		<div class="span4">
			<h4><?php echo JText::_('COM_JCCDEV_TABLE_FIELDSET_VIEWS'); ?></h4>
			<div class="control-group">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'table', 'corefunctions', JText::_('COM_JCCDEV_TABLE_FIELDSET_COREFUNCTIONS'), true); ?>
	<div class="row-fluid">
		<h4><?php echo JText::_('COM_JCCDEV_TABLE_FIELDSET_JOOMLA_DB_PATTERN'); ?></h4>
			<div class="span4">
			<?php 
				$i = 0;
