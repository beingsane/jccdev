...
<div class="row-fluid">
	<div class="span6">
		<h2><?php echo JText::_("COM_JCCDEV_COMPONENT_INFO") ?></h2>
		<table class="table">
			<tbody>
				<tr>
					<td><?php echo JText::_("COM_JCCDEV_COMPONENT_FIELD_VERSION_LABEL") ?>:</td>
					<td><?php echo $this->item->version; ?></td>
				</tr>
				<tr>
					<td><?php echo JText::_("COM_JCCDEV_COMPONENT_FIELD_SITE_LABEL") ?>:</td>
					<td><span class="badge badge-<?php echo $this->item->site ? "success" : "important"; ?>">
				...
				<tr>
					<td><?php echo JText::_("COM_JCCDEV_COMPONENT_FIELD_INSTALLED_LABEL") ?>:</td>
					<td>
						...
						<?php if ($this->item->installed) : ?>
							<a class="badge badge-info" href="<?php echo JURI::base(); ?>index.php?option=com_<?php echo $this->item->name; ?>"><?php echo JText::_("COM_JCCDEV_BACKEND") ?></a>
							<?php if ($this->item->site) : ?>
								<a class="badge badge-info" href="<?php echo JURI::root(); ?>index.php?option=com_<?php echo $this->item->name; ?>"><?php echo JText::_("COM_JCCDEV_FRONTEND") ?></a>
							<?php endif; ?>
						<?php endif; ?>
					</td>
				</tr>
				<tr>
					<td><?php echo JText::_("COM_JCCDEV_COMPONENT_FIELD_LANGUAGES_LABEL") ?>:</td>
					<td>
				...
				<tr>
					<td><?php echo JText::_("COM_JCCDEV_COMPONENT_FIELD_AUTHOR_LABEL") ?>:</td>
					<td>
						<i class="icon-user"></i>
	...
	<div class="span1">&nbsp;</div>
	<div class="span5">
		<h2><?php echo JText::_("COM_JCCDEV_COMPONENT_DOWNLOAD") ?></h2>
		<table class="table">
			<tbody>
				<tr>
