...
$override_admin = JRoute::_("index.php?option=com_jccdev&task=override.add&type=component.admin&item_id=" . $this->item->id);
$override_site = JRoute::_("index.php?option=com_jccdev&task=override.add&type=component.site&item_id=" . $this->item->id);
$span = $this->item->site ? "span6" : "span12";
?>
		<h2><?php echo JText::_("COM_JCCDEV_COMPONENT_OVERRIDES") ?></h2>
		...
		<a href="<?php echo JRoute::_("index.php?option=com_jccdev&view=overrides&filter[type]=component.admin&filter[item_id]=" . $this->item->id); ?>" class="btn btn-primary"><?php echo JText::_("COM_JCCDEV_OVERRIDES_MANAGE") ?></a>
		<p>&nbsp;</p>
		<div class="row-fluid">
			<div class="<?php echo $span; ?>">
				<h3><?php echo JText::_("COM_JCCDEV_COMPONENT_OVERRIDES_ADMIN"); ?></h3>
			...
			<div class="span6">
				<h3><?php echo JText::_("COM_JCCDEV_COMPONENT_OVERRIDES_SITE"); ?></h3>
				<table class="table table-striped">
					<tbody>
		...
		<div class="modal hide fade" id="addOverride" style="width:800px;">
			<div class="modal-header">
				<h3><?php echo JText::sprintf('COM_JCCDEV_COMPONENT_ADD_OVERRIDE');?></h3>
			</div>
			<div class="modal-body">
				<?php echo JText::sprintf('COM_JCCDEV_COMPONENT_ADD_OVERRIDE_DESC');?>
				<div class="row-fluid">
					<div class="<?php echo $span; ?>">
						<table class="table table-striped">
							<thead>
								<tr>
									<th><?php echo JText::_("COM_JCCDEV_COMPONENT_OVERRIDES_ADMIN"); ?></th>
								</tr>					
							</thead>
							<tbody>
								<tr>
					...
					<div class="span6">
						<table class="table table-striped">
							<thead>
								<tr>
									<th><?php echo JText::_("COM_JCCDEV_COMPONENT_OVERRIDES_SITE"); ?></th>
								</tr>					
							</thead>
							<tbody>
								<tr>
