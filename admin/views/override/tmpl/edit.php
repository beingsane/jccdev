...
<form action="<?php JRoute::_('index.php?option=com_jccdev&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="override-form" class="form-validate form-horizontal">
	<h3><?php echo JText::_("COM_JCCDEV_OVERRIDE"); ?></h3>
