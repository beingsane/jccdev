...
<form action="<?php JRoute::_('index.php?option=com_jccdev'); ?>" method="post" name="adminForm" id="module-form" class="form-validate form-horizontal">
<div class="row-fluid">

<div id="j-main-container" class="span12">
	<?php echo JHtml::_('bootstrap.startTabSet', 'module', array('active' => 'general')); ?>
		<?php echo JHtml::_('bootstrap.addTab', 'module', 'general', JText::_('COM_JCCDEV_MODULE_VIEW'), true); ?>
	<div class="row-fluid">
		<div class="span4">
			<h4><?php echo JText::_('COM_JCCDEV_MODULE_FIELDSET_LABEL'); ?></h4>
