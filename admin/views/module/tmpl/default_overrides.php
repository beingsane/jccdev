...
$override_add = JRoute::_("index.php?option=com_jccdev&task=override.add&type=module&item_id=" . $this->item->id);
?>
<div class="row-fluid">
	<div class="span12">
		<h2><?php echo JText::_("COM_JCCDEV_MODULE_OVERRIDES") ?></h2>
		...
		<a href="<?php echo JRoute::_("index.php?option=com_jccdev&view=overrides&filter[type]=module&filter[item_id]=" . $this->item->id); ?>" class="btn btn-primary"><?php echo JText::_("COM_JCCDEV_OVERRIDES_MANAGE") ?></a>
		<p>&nbsp;</p>
		...
		<div class="modal hide fade" id="addOverride" style="width:600px;">
			...
			<div class="modal-body">
				...
				<table class="table table-striped">
					...
					<tbody>
						<tr>
							<td><a href="<?php echo $override_add. "&name=module.php"; ?>">module.php</a></td>
						</tr>
						<tr>
							<td><a href="<?php echo $override_add. "&name=helper.php"; ?>">helper.php</a></td>
						</tr>
						<tr>
							<td><a href="<?php echo $override_add. "&name=tmpl.default.php"; ?>">tmpl.default.php</a></td>
						</tr>
					</tbody>
				</table>
			</div>
