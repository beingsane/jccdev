...
<form action="<?php JRoute::_('index.php?option=com_jccdev&id=' . (int) $this->item->name); ?>" method="post" name="adminForm" id="formfield-form" class="form-validate form-horizontal">
