...
<h2><?php echo !empty($this->item->name) ? $this->item->name : JText::_("COM_JCCDEV_FIELD_NEW"); ?></h2>
<form action="<?php JRoute::_('index.php?option=com_jccdev&id=' . (int)$this->item->id); ?>" method="post" name="adminForm" id="field-form" class="form-validate form-horizontal">
<div class="row-fluid">
<div id="j-main-container" class="span12">

	<?php echo JHtml::_('bootstrap.startTabSet', 'field', array('active' => 'general')); ?>
		<?php echo JHtml::_('bootstrap.addTab', 'field', 'general', (int)$this->item->id ? ucfirst($this->item->name) : JText::_('COM_JCCDEV_FIELD_NEW'), true); ?>
	<div class="row-fluid">
		<div class="span4">
			<h4><?php echo JText::_('COM_JCCDEV_FIELD_FIELDSET_DATABASE_LABEL'); ?></h4>
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<span class="label label-info">
						<a href="http://docs.joomla.org/Standard_form_field_types" target="_blank" style="color:#fff;"><?php echo JText::_('COM_JCCDEV_FIELD_FIELD_TYPE_INFO') ?></a>
					</span>
					<span class="label label-warning">
						<a href="<?php echo JRoute::_("index.php?option=com_jccdev&view=formfields"); ?>" target="_blank" style="color:#fff;"><?php echo JText::_('COM_JCCDEV_FIELD_FIELD_TYPE_CREATE'); ?></a>
					</span>
				</div>
			</div>
			<div class="control-group">
		...
		<div class="span4">
			<h4><?php echo JText::_('COM_JCCDEV_FIELD_FIELDSET_FORM_LABEL'); ?></h4>			
			<div class="control-group">
				<div class="control-label"><?php echo $this->form->getLabel('rule'); ?></div>
				<div class="controls">
					<?php echo $this->form->getInput('rule'); ?><br>
					<span class="label label-info">
						<a href="http://docs.joomla.org/Server-side_form_validation" target="_blank" style="color:#fff;"><?php echo JText::_('COM_JCCDEV_FIELD_FIELD_RULE_INFO') ?></a>
					</span>
					<span class="label label-warning">
						<a href="<?php echo JRoute::_("index.php?option=com_jccdev&view=formrules"); ?>" target="_blank" style="color:#fff;"><?php echo JText::_('COM_JCCDEV_FIELD_FIELD_RULE_CREATE'); ?></a>
					</span>
				</div>
			</div>
		...
		<div class="span4">
			<h4><?php echo JText::_('COM_JCCDEV_FIELD_FIELDSET_VIEW_LABEL'); ?></h4>			
