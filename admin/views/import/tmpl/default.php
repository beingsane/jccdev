...
<?php endif;?>
	<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => $active)); ?>
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'component', JText::_('COM_JCCDEV_IMPORT_FIELDSET_COMPONENT'), true); ?>
		<div class="well">
			<form action="<?php echo JRoute::_('index.php?option=com_jccdev&task=import.componentfrommanifest', false); ?>" method="post" class="form-validate form-horizontal" name="adminForm" id="adminForm"  enctype="multipart/form-data">
				<h4><?php echo JText::_("COM_JCCDEV_IMPORT_COMPONENT_FROM_MANIFEST"); ?></h4>
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'table', JText::_('COM_JCCDEV_IMPORT_FIELDSET_TABLE'), true); ?>
		<div class="well">
			<form action="<?php echo JRoute::_('index.php?option=com_jccdev&task=import.tablefromdb', false); ?>" method="post" class="form-validate form-horizontal">
				<h4><?php echo JText::_("COM_JCCDEV_IMPORT_TABLE_FROM_DATABASE"); ?></h4>
				<div class="control-group">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'fields', JText::_('COM_JCCDEV_IMPORT_FIELDSET_FIELD'), true); ?>
		<div class="well">
			<form action="<?php echo JRoute::_('index.php?option=com_jccdev&task=import.fieldsfromform', false); ?>" method="post" class="form-validate form-horizontal" name="adminForm" id="adminForm"  enctype="multipart/form-data">
				<h4><?php echo JText::_("COM_JCCDEV_IMPORT_FIELDS_FROM_FORM"); ?></h4>
				<div class="control-group">
