...
<form action="<?php JRoute::_('index.php?option=com_jccdev&id=' . (int) $this->item->name); ?>" method="post" name="adminForm" id="formrule-form" class="form-validate form-horizontal">
