	...
	<div class="sidebar-nav quick-icons">
		<div class="j-links-groups">
			...
			<ul class="j-links-group nav nav-list">
			  <li>
				<a href="<?php echo JRoute::_("index.php?option=com_jccdev&view=components") ?>">
				  <i class="icon-cube"></i>
				  <span class="j-links-link"><?php echo JText::_("COM_JCCDEV_SUBMENU_COMPONENTS"); ?></span>
				</a>
			  </li>
			  <li>
				<a href="<?php echo JRoute::_("index.php?option=com_jccdev&view=tables") ?>">
				  <i class="icon-cube"></i>
				  <span class="j-links-link"><?php echo JText::_("COM_JCCDEV_SUBMENU_TABLES"); ?></span>
				</a>
			  </li>
			  <li>
				<a href="<?php echo JRoute::_("index.php?option=com_jccdev&view=fields") ?>">
				  <i class="icon-cube"></i>
				  <span class="j-links-link"><?php echo JText::_("COM_JCCDEV_SUBMENU_FIELDS"); ?></span>
				</a>
			  </li>
			  <li>
				<a href="<?php echo JRoute::_("index.php?option=com_jccdev&view=formfields") ?>">
				  <i class="icon-cube"></i>
				  <span class="j-links-link"><?php echo JText::_("COM_JCCDEV_SUBMENU_FORMFIELDS"); ?></span>
				</a>
			  </li>
			  <li>
				<a href="<?php echo JRoute::_("index.php?option=com_jccdev&view=formrules") ?>">
				  <i class="icon-cube"></i>
			...
			<ul class="j-links-group nav nav-list">
			  <li>
				<a href="<?php echo JRoute::_("index.php?option=com_jccdev&view=modules") ?>">
				  <i class="icon-cube"></i>
				  <span class="j-links-link"><?php echo JText::_("COM_JCCDEV_SUBMENU_MODULES"); ?></span>
				</a>
			  </li>
			  <li>
				<a href="<?php echo JRoute::_("index.php?option=com_jccdev&view=plugins") ?>">
				  <i class="icon-cube"></i>
				  <span class="j-links-link"><?php echo JText::_("COM_JCCDEV_SUBMENU_PLUGINS"); ?></span>
				</a>
			  </li>
			  <li>
				<a href="<?php echo JRoute::_("index.php?option=com_jccdev&view=templates") ?>">
				  <i class="icon-cube"></i>
				  <span class="j-links-link"><?php echo JText::_("COM_JCCDEV_SUBMENU_TEMPLATES"); ?></span>
				</a>
			  </li>
			  <li>
				<a href="<?php echo JRoute::_("index.php?option=com_jccdev&view=packages") ?>">
				  <i class="icon-cube"></i>
			...
			<ul class="j-links-group nav nav-list">
			  <li>
				<a href="<?php echo JRoute::_("index.php?option=com_jccdev&view=import") ?>">
				  <i class="icon-download"></i>
				  <span class="j-links-link"><?php echo JText::_("COM_JCCDEV_SUBMENU_IMPORT"); ?></span>
				</a>
			  </li>
			  <li>
				<a href="<?php echo JRoute::_("index.php?option=com_jccdev&view=extensions") ?>">
