...
/**
 * JCCDev Component Table
 *
 * @package     JCCDev
 * @subpackage  Tables
 */
class JCCDevTableComponent extends JTable
{
	public function __construct($db)
	{
		parent::__construct('#__jccdev_components', 'id', $db);
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (!$this->id)
		{
			...
			$table = JTable::getInstance('Component', 'JCCDevTable');
