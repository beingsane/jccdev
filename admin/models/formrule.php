...
/**
 * JCCDev Formrule Model
 *
 * @package     JCCDev
 * @subpackage  Models
 */
class JCCDevModelFormrule extends JModelAdmin
{
	/**
	 ...
	 * @throws  Exception
	 */
	public function getTable($type = 'Formrule', $prefix = 'JCCDevTable', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_jccdev.edit.formrule.data', array());
	...
	protected function prepareTable($table)
	{
		...
		$dir = JCCDevTEMPLATES . "/com/admin/models/rules/rule.php";
