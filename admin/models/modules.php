...
/**
 * JCCDev Modules Model
 *
 * @package     JCCDev
 * @subpackage  Models
 */
class JCCDevModelModules extends JModelList
{
	/**
	 * Constructor
	 *
	...
	protected function getListQuery()
	{
		...
		$query->select('a.*')->from('#__jccdev_modules AS a');
	...
	public function getAuthors()
	{
		...
		$query->select('u.id AS value, u.name AS text')
			->from('#__users AS u')
			->join('INNER', '#__jccdev_modules AS a ON a.created_by = u.id')
			->group('u.id, u.name')
			->order('u.name');
