...
/**
 * JCCDev Overrides Model
 *
 * @package     JCCDev
 * @subpackage  Models
 */
class JCCDevModelOverrides extends JModelList
{
	/*
	 * Constructor.
	 *
	...
	public function getOverrides($type, $item_id)
	{
		...
		$query->select("a.id, a.name")->from("#__jccdev_overrides AS a")
	...
	protected function getListQuery()
	{
		...
		$query = $db->getQuery(true);
		$query->select('a.*')->from($db->quoteName('#__jccdev_overrides') . 'AS a');
