...
/**
 * JCCDev Templates Model
 *
 * @package     JCCDev
 * @subpackage  Models
 */
class JCCDevModelTemplates extends JModelList
{
	/**
	 * Constructor
	 *
	...
	public function getItems()
	{
		...
		foreach ($items as $item)
		{
			...
			$item->installed = JCCDevInstall::isInstalled("template", $item->name);
	...
	protected function getListQuery()
	{
		...
		$query->select('a.*')->from('#__jccdev_templates AS a');
	...
	public function getAuthors()
	{
		...
		$query->select('u.id AS value, u.name AS text')
			->from('#__users AS u')
			->join('INNER', '#__jccdev_templates AS a ON a.created_by = u.id')
			->group('u.id, u.name')
			->order('u.name');
