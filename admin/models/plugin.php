 ...
 * @subpackage  Models
 */
class JCCDevModelPlugin extends JModelAdmin
{
	/**
	 ...
	 * @throws  Exception
	 */
	public function getTable($type = 'Plugin', $prefix = 'JCCDevTable', $config = array())
	{
	...
	{
		$app = JFactory::getApplication();
		$data = $app->getUserState('com_jccdev.edit.plugin.data', array());
