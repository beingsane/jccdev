 ...
 * @subpackage  Models
 */
class JCCDevModelForms extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->select('a.*')->from('#__jccdev_forms AS a');				
		...
		{
			$parent = JModelLegacy::getInstance("Form", "JCCDevModel")->getItem($parent_id);
	...
	public function getAuthors()
	{
		...
		$query->select('u.id AS value, u.name AS text')
			->from('#__users AS u')
			->join('INNER', '#__jccdev_forms AS a ON a.created_by = u.id')
			->group('u.id, u.name')
			->order('u.name');
