 ...
 * @subpackage  Models
 */
class JCCDevModelForm extends JModelAdmin
{
	/**
	 * @var        string    The prefix to use with controller messages.
	 * @since   1.6
	 */
	protected $text_prefix = 'COM_JCCDEV';
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_jccdev.form';
	 ...
	 */
	public function getTable($type = 'Form', $prefix = 'JCCDevTable', $config = array())
	{
