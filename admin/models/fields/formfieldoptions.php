...
class JFormFieldFormFieldOptions extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		$model = JModelLegacy::getInstance($this->element["model"], "JCCDevModel");
		$id = $input->get("id", 0, "int");
		$field = $model->getItem($id);
		
		$input = "<table class=\"field-options\">";
		$input .= "<tr><th>" . JText::_("COM_JCCDEV_FORM_OPTION_KEY") . "</th>";
		$input .= "<th>" . JText::_("COM_JCCDEV_FORM_OPTION_VALUE") . "</th></tr>";
		...
		class=\"btn btn-success\">" . JText::_("COM_JCCDEV_FORM_ADD_OPTION") . "</a>";
	...
	{
		$input = JFactory::getApplication()->input;
		$model = JModelLegacy::getInstance("Form", "JCCDevModel");
		$id = $input->get("id", 0, "int");
		$field = $model->getItem($id);
