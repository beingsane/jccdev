 ...
 * @subpackage	Fields
 */
class JFormFieldJCCDevTables extends JFormFieldGroupedlist
{
	/**
	 * The form field type.
	 *
	...
	{		
		...
		$query->select("a.id, a.name")->from("#__jccdev_tables as a");
		$query->select('c.name AS component, c.display_name AS component_name')->join('LEFT', '#__jccdev_components AS c ON c.id = a.component');
