...
/**
 * JCCDev ImportXml Model
 *
 * @package     JCCDev
 * @subpackage  Models
 */
class JCCDevModelImportXml extends JModelLegacy
{
	/**
	...
	{
		JCCDevLoader::importHelper("field");
		...
		foreach ($form->fieldset->children() as $_field)
		{
			...
			$field["dbtype"] = JCCDevHelperField::getDbType((string) $_field["type"]);
