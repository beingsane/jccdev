CREATE TABLE IF NOT EXISTS `#__jccdev_components` (
...
CREATE TABLE IF NOT EXISTS `#__jccdev_fields` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
  `ordering` smallint(5) NOT NULL COMMENT 'Table ordering',
...
CREATE TABLE IF NOT EXISTS `#__jccdev_forms` (
...
INSERT INTO `#__jccdev_forms` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `name`, `alias`) VALUES (NULL, '0', '0', '1', '0', '', 'Root', 'root');
...
CREATE TABLE IF NOT EXISTS `#__jccdev_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
  `ordering` smallint(5) NOT NULL COMMENT 'Table ordering',
  `name` varchar(40)NOT NULL,
  `display_name` varchar(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__jccdev_overrides` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
...
CREATE TABLE IF NOT EXISTS `#__jccdev_tables` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
  `ordering` smallint(5) NOT NULL COMMENT 'Table ordering',
  `name` varchar(40)NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__jccdev_templates` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
  `ordering` smallint(5) NOT NULL COMMENT 'Table ordering',
  `name` varchar(40)NOT NULL,
  `version` varchar(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__jccdev_plugins` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary key',
  `ordering` smallint(5) NOT NULL COMMENT 'Table ordering',
  `name` varchar(40)NOT NULL,
  `display_name` varchar(100) NOT NULL,
